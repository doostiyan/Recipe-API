...
class PublicIngredientApiTests(TestCase):
    ...
    def test_filter_ingredient_assigned_to_recipe(self):
        ...
        recipe = Recipe.objects.create(title="Apples Crumble", time_minutes=5, price=Decimal("4.50"), user=self.user)
    ...
    def test_filtered_ingredient_unique(self):
        ...
        recipe2 = Recipe.objects.create(title="Herb Eggs", time_minutes=30, price=Decimal("5.00"), user=self.user)
